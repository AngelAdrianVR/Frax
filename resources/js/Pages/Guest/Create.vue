              ...
              <div>
                  ...
                  <section v-if="guestForm.type == 'Visita'">
                      <div class="relative">
                          ...
                          <p @click="guestForm.reset(); favoriteGuestModal = true; guestForm.qr_code = eventForm.qr_code" class="text-primary text-xs underline cursor-pointer absolute right-2 top-[2px]">Seleccionar visita frecuente</p>
        ...
        <div class="mx-7 my-4 space-y-4 relative">
          ...
          <section v-if="selectedFavoriteGuest" class="lg:grid grid-cols-2">
            ...
            <div>
              ...
              <p v-if="!selectedFavoriteGuest?.vehicle_details" class="text-xs text-red-600">Tu visita frecuente no tiene vehículos registrados*</p>
                <!-- --------- info vehículos ----------- -->

      ...
      <form @submit.prevent="store" class="mx-8 mt-9 grid grid-cols-2 gap-9 p-4">
        <div>
          ...
          <section v-if="guestForm.type == 'Visita'">
            ...
            <div class="mt-4">
              ...
              <figure @click="triggerGuestImageInput"
                class="flex items-center justify-center rounded-md border border-dashed border-[#373737] w-48 h-36 cursor-pointer relative">
                <i v-if="guestImage" @click.stop="guestImage = null; guestForm.guest_image = null"
                ...
                <img v-if="guestImage" :src="guestImage" alt="Vista previa"
          ...
          <div class="rounded-md border border-[#D9D9D9] mt-3" v-if="guestForm.guest_type == 'Vehicular'">
            ...
            <div class="pt-1 pb-5 px-7">
              <div>
                ...
                <figure @click="triggerVehicleImageInput"
                  class="flex items-center justify-center rounded-md border border-dashed border-[#373737] w-48 h-36 cursor-pointer relative">
                  <i v-if="vehicleImage" @click.stop="vehicleImage = null; guestForm.vehicle_image = null"
                    class="fa-solid fa-xmark absolute p-1 top-1 right-1 z-10 text-sm"></i>
                  <i v-if="!vehicleImage" class="fa-solid fa-camera text-gray-400 text-xl"></i>
                  <img v-if="vehicleImage" :src="vehicleImage" alt="Vista previa"
                    class="w-full h-full  object-contain bg-no-repeat rounded-md opacity-50" />
        ...
        <section class="col-start-1" v-if="guestForm.type == 'Evento'">
          ...
          <div class="mt-3">
            ...
            <el-time-select v-model="eventForm.start_time" class="mr-4" placeholder="Hora de inicio" start="07:00"
            ...
            <el-time-select v-model="eventForm.end_time" placeholder="Hora de terminación" start="07:00" step="00:15"
              end="22:00" :disabled="eventForm.is_all_day" />
          ...
          <el-select @change="findFavoriteGuest" class="w-full" v-model="favoriteGuestId" clearable filterable
            ...
            <el-option v-for="item in favorite_guests.data" :key="item" :label="item.name" :value="item.id">
              <figure v-if="item.media_guest?.length > 0" style="float: left">
                <img class="object-contain bg-no-repeat w-6 h-6 rounded-full mt-1"
                  :src="item.media_guest[0]?.original_url" alt="" />
              </figure>

    ...
    <AppLayout title="Editar servicio">
        <div class="lg:py-7 lg:px-10 py-2 px-1">
          ...
          <form @submit.prevent="update" class="mx-8 mt-9 md:grid grid-cols-2 md:gap-9 md:p-4">
            ...
            <section> 
                <h1 class="font-bold mb-5">Editar servicio "{{ service.name }}"</h1>
                <div class="mt-3">
...
data(){
    ...
    is_internal: !!this.service.is_internal,
    ...
    return {
        form,
        social_networks: {
            website: this.service.social_networks?.website,
            facebook: this.service.social_networks?.facebook,
            instagram: this.service.social_networks?.instagram,
            tiktok: this.service.social_networks?.tiktok,
            x: this.service.social_networks?.x,
        },
    }
},
components:{
...
methods:{
update() {
    this.form.social_networks = this.social_networks; //Se guarda el objeto de redes sociales en formulario para mandarse a controlador
